...
function draw() {
  ...
  if(monster.body.position.y>750){
    Matter.Body.setPosition(hero.body,{x:700,y:200})
    textSize(30)
    stroke(119, 3, 130)
    fill(119, 3, 130)
    text("Don't worry! Everyhting is fine! Now just enjoy Diwali!",200,500)
    ...
    stroke(119, 3, 130)
    fill(119, 3, 130)
    text("Supergirl is here to save the day!",100,100)
  }
}
